const speakers = [
  {
    ...
    bio: 'Conferencista internacional en liderazgo pastoral y desarrollo de comunidades de fe.',
    image: 'https://i.pravatar.cc/300?img=12',
    topics: ['Liderazgo', 'Pastoral'],
  },
  {
    name: 'Pr. Eliseo de la Cruz',
    role: 'Pastor principal de la iglesia La Hermosa en Lima, Perú',
    bio: 'Conferencista internacional en liderazgo pastoral y desarrollo de comunidades de fe.',
    image: 'https://i.pravatar.cc/300?img=12',
    topics: ['Liderazgo', 'Pastoral'],
  },
